...
style: {transitionDelay: "1s"},
    ...
    <div  role="img" aria-label="movie image" title="wmovie image"  className=' rounded-lg cursor-pointer overflow-hidden w-36 sm:w-48 h-60 sm:h-72 group relative ' onClick={()=>router.push(`/details/${type}/${data.id}/1`) } >
      <img className=' w-full h-full object-cover object-center absolute z-20 ' src={`${Api}${data.poster_path}`} loading='lazy' alt='image' />
