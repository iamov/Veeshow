...
const SignUp = () => {
  ...
  return (
    <div className=' w-full px-8'>
            ...
            initialValues={{email:"", password:"",user_name:""}}
                            ...
                            return(
                                <div>
                                  ...
                                  <div className=' mb-5 text-white'>
                                        ...
                                        <input id="name" type='text' className=' text-white  placeholder:text-white px-4 w-full h-12 mt-2 border-[1px] bg-gray-900 border-gray-200' value={prop.values.user_name} onChange={prop.handleChange('user_name')}/>
                                    ...
                                    <div>
                                        {load?        <div className=' flex justify-center'>
                                                        ...
                                                        </div>:<input type='submit' className='bg-red-500 w-full font-semibold py-3  text-white  cursor-pointer' value={"SIGN UP"} onClick={prop.handleSubmit}/>}
                                    </div>
                                </div>
                            )
                    }
